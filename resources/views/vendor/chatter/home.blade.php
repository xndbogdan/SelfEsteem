							...
							@foreach($discussions as $discussion)
								<li>
									...
									<div class="container offset-0">
										<a href="" class="mr-2" data-toggle="tooltip" data-placement="bottom" title="Like"><span><i class="fa fa-2x fa-heart-o text-danger"></i></span></a>
										<a href="" data-toggle="tooltip" data-placement="bottom" title="Bookmark"><span><i class="fa fa-2x fa-bookmark-o text-muted"></i></span></a>
									</div>
